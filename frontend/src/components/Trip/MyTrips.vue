        ...
        <v-card class="mx-auto" max-width="800">
            ...
            <v-card-text>
                <div class="button-container">
                    <v-btn @click="fetchTrips('name', true)" class="order-button">Organizer</v-btn>
                    <v-btn @click="fetchTrips('name', false)" class="order-button">Participant</v-btn>
                </div>
...
export default {
    ...
    methods: {
        ...
        fetchTrips(orderBy = 'name', organizer = true) {
            const endpoint = organizer ? "http://localhost:8000/trip/my_trips_organizer/" : "http://localhost:8000/trip/my_trips_participant/";
            apiClient
                .get(endpoint, {
                    params: {
                        order_by: orderBy,
